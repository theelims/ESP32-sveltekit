...
public:
    WebSocketTx(JsonStateReader<T> stateReader,
                ...
                size_t bufferSize = DEFAULT_BUFFER_SIZE) : WebSocketConnector<T>(statefulService,
                                                                                 server,
                                                                                 webSocketPath,
                                                                                 securityManager,
    ...
    WebSocketTx(JsonStateReader<T> stateReader,
                ...
                AsyncWebServer *server,
                const char *webSocketPath,
                size_t bufferSize = DEFAULT_BUFFER_SIZE) : WebSocketConnector<T>(statefulService, server, webSocketPath, bufferSize), _stateReader(stateReader)
    {
        WebSocketConnector<T>::_statefulService->addUpdateHandler(
            [&](const String &originId)
            { transmitData(nullptr, originId); },
...
public:
    ...
    WebSocketRx(JsonStateUpdater<T> stateUpdater,
                ...
                AsyncWebServer *server,
                const char *webSocketPath,
                size_t bufferSize = DEFAULT_BUFFER_SIZE) : WebSocketConnector<T>(statefulService, server, webSocketPath, bufferSize), _stateUpdater(stateUpdater)
    {
    }
...
public:
    ...
    WebSocketTxRx(JsonStateReader<T> stateReader,
                  ...
                  AsyncWebServer *server,
                  const char *webSocketPath,
                  size_t bufferSize = DEFAULT_BUFFER_SIZE) : WebSocketConnector<T>(statefulService, server, webSocketPath, bufferSize),
