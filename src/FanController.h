...
#define CONTROLLER_PWM_TIMER_NUM LEDC_TIMER_0
#define CONTROLLER_PWM_CHANNEL_SUPPLY_FAN LEDC_CHANNEL_0
#define CONTROLLER_PWM_CHANNEL_EXHAUST_FAN LEDC_CHANNEL_1
